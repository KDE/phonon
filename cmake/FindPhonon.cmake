...
if(PHONON_FOUND)
   ...
   message(STATUS "PHONON_FOUND: ${PHONON_FOUND}")
   message(STATUS "PHONON_INCLUDES: ${PHONON_INCLUDES}")
   message(STATUS "PHONON_LIBS: ${PHONON_LIBS}")
   message(STATUS "PHONON_INCLUDE_DIR: ${PHONON_INCLUDE_DIR}")
   message(STATUS "PHONON_LIBRARY: ${PHONON_LIBRARY}")
endif(PHONON_FOUND)
